...
Note that while there are various correct ways to create a board markup for this style of game, your solution must follow this format in order for our CSS and tests to work properly.
